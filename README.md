# Project 2 - *SimpleNewYorkTimes*

**SimpleNewYorkTimes** is an android app that allows a user to search for articles on web using simple filters. The app utilizes [New York Times Search API](http://developer.nytimes.com/docs/read/article_search_api_v2).
...
* [x] For different news articles that score is more than 2.5 or not, use [Heterogenous Layouts](http://guides.codepath.com/android/Heterogenous-Layouts-inside-RecyclerView) with RecyclerView
...
* [x] Splash Screen
* [x] Show a progress bar when loading data
* [x] In MainActivity, click toolbar to scroll to top.
* [x] Add a RESET feature to filter.
...
1. It is so great to use Parceler library to serialize object instead of do it manually.
2. To use the SearchView without the Toolbar, we can set its iconfied to be false.
